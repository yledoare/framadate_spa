...
const ADRESSEMAILADMIN = 'yann@framadate.org';
...
// Database password
const DB_PASSWORD = 'framadatepasswd';
...
$config = [
    ...
    'smtp_options' => [
        'host' => 'smtp:1025',            // SMTP server (you could add many servers (main and backup for example) : use ";" like separator
    ...
    'default_poll_duration' => 2,         // default values for the new poll duration (number of days).
